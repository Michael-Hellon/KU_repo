...
// END of First test -  works to here //
...
// test to see if random number is returned
console.log(`Congratulations to our 2nd Employ ${employeesArray.firstName[randomNumber]} ${employeesArray.lastName[randomNumber]}, our random drawing winner!!!`)
